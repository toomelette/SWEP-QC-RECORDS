    ...
    <div class="box">
      ...
      <form role="form" method="POST" autocomplete="off" action="{{ route('dashboard.email_contact.store') }}">
        ...
        <div class="box-body">
          ...
          {!! __form::textbox(
             '6', 'name', 'text', 'Name / Description *', 'Name / Description', old('name'), $errors->has('name'), $errors->first('name'), ''
          ) !!}

          {!! __form::textbox(
            '6', 'category', 'text', 'Category', 'Category', old('category'), $errors->has('category'), $errors->first('category'), ''
          ) !!}
          ...
          {!! __form::textbox(
             '6', 'contact_no', 'text', 'Contact No.', 'Contact No.', old('contact_no'), $errors->has('contact_no'), $errors->first('contact_no'), ''
          ) !!}
